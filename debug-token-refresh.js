...
class TokenRefreshDebugger {
    ...
    async debugRefresh() {
        try {
            ...
            // Prepare request options - FIXED: Removed Cookie header with expired access token
            ...
            // REMOVED: Cookie header that was causing 401 errors
            await utils.log('Making refresh request with refreshToken in body only (no Cookie header)', this.logFile);
